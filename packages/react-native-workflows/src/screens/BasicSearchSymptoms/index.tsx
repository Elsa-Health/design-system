...
import { SearchInput } from '@elsa-ui/react-native/components/input';
import { RevealContent } from '@elsa-ui/react-native/components/misc';
...
import { XIcon, CheckIcon } from '@elsa-ui/react-native/visuals/vectors';
...
function SearchResults(props: { onSelectSymptom: (id: SymptomId) => void }) {
  ...
  const renderItem = React.useCallback(
    ({ item: { id, present } }: { item: { id: string; present: boolean } }) => {
