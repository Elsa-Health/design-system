...
export { default as ElsaColorableIcon } from './vectors/ElsaColorableIcon';
export { default as ElsaIcon } from './vectors/ElsaIcon';

export const ArrowBackIcon = React.memo(
  React.forwardRef((props: SvgProps & { style: SvgProps }, svgRef: any) => {
    return (
      <Svg
        width={24}
        height={24}
